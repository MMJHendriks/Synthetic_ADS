This repository serves as research archive for the [Master's thesis](https://github.com/MMJHendriks/Synthetic_ADS/blob/main/SimulationStudy_MHendriks/Thesis_SyntheticDataMICE_MHendriks.pdf) 'MICE to Synthesize: Generating Synthetic Data Sets with MICE for the Analysis of Private Data' by Mirthe Hendriks. The aim of this thesis is to establish a proof-of-concept for generating high-quality partially synthetic data with multiple imputations in MICE for the analysis of privacy-sensitive data.
...
The thesis manuscript is named [Thesis_SyntheticDataMICE_MHendriks](https://github.com/MMJHendriks/Synthetic_ADS/blob/main/SimulationStudy_MHendriks/Thesis_SyntheticDataMICE_MHendriks.pdf). There is a seperate bib file for the [references](https://github.com/MMJHendriks/Synthetic_ADS/blob/main/SimulationStudy_MHendriks/References.bib). For those who are interested, there is also a [thesis presentation](https://github.com/MMJHendriks/Synthetic_ADS/blob/main/SimulationStudy_MHendriks/ThesisPresentation_SyntheticDataMICE.pptx) one might have a look at. 
