...
save(SynData_imp_boot, file = "Workspaces/1.2 Generate synthetic data_bootstrapped sample.Rdata")
#OR scenario 2
#save(SynData_imp_boot, file = "Workspaces/2.2 Generate synthetic data_bootstrapped sample.Rdata")