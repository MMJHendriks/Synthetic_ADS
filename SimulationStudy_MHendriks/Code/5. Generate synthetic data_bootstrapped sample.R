...
SynData_imp_boot <- list(synboot_cart_m = synboot_cart_m, synboot_cart_cpm = synboot_cart_cpm, 
                         synboot_cart_mmx1 = synboot_cart_mmx1, synboot_cart_cpmmx1 = synboot_cart_cpmmx1)

save(SynData_imp_boot, file = "Workspaces/1.5 Generate synthetic data_bootstrapped sample.Rdata")
#OR scenario 2
#save(SynData_imp_boot, file = "Workspaces/2.5 Generate synthetic data_bootstrapped sample.Rdata")