...
Pred_SynData_imp_complete <- list(pred_truesyn_out = pred_truesyn_out, pred_truesyn2_out = pred_truesyn2_out,
                                  pred_syn_cart_m = pred_syn_cart_m, pred_syn_cart_cpm = pred_syn_cart_cpm)

save(Pred_SynData_imp_complete, file = "Workspaces/1.4 Prediction synthetic data_complete PID.Rdata")
#OR scenario 2
#save(Pred_SynData_imp_complete, file = "Workspaces/2.4 Prediction synthetic data_complete PID.Rdata")
