...
Eval_SynData_imp_complete <- list(eval_syn_pmm = eval_syn_pmm, eval_syn_cart_m = eval_syn_cart_m, eval_syn_cart_cpm = eval_syn_cart_cpm,
                                  uni_syn_cart_m = uni_syn_cart_m, uni_syn_cart_cpm = uni_syn_cart_cpm)

save(Eval_SynData_imp_complete, file = "Workspaces/1.3 Evaluation synthetic data_complete PID.Rdata")
#OR scenario 2
#save(Eval_SynData_imp_complete, file = "Workspaces/2.3 Evaluation synthetic data_complete PID.Rdata")
